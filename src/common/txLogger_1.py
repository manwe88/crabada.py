...
from src.common.logger_1 import f_handler, c_handler
...
# Create handlers
tx_handler = logging.handlers.TimedRotatingFileHandler('storage/logs/transactions/transactions1.log', 'midnight')
